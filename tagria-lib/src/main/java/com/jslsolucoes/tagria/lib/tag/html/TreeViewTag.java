...
public class TreeViewTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		script.add("$('#" + container.get(Attribute.ID) + "').treeview({ multiple : " + multiple + " , url : '"
				+ TagUtil.getPathForUrl(getJspContext(), url) + "', folderIcon : '"
				+ TagUtil.getPathForImageLibResource(getJspContext(), "treeview-tree.png") + "' , fileIcon : '"
				+ TagUtil.getPathForImageLibResource(getJspContext(), "treeview-leaf.png") + "',name : '" + name
				+ "'});");
